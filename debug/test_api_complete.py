#!/usr/bin/env python3
"""
🧪 Script de Teste Completo da API ProtecAI Mini (Standalone)
============================================================

Script standalone para testar todos os endpoints da API.
Para usar com pytest, use test_api_endpoints.py em vez deste.
"""
...
def test_endpoint(method, endpoint, data=None, expected_status=200):
    ...
    try:
        ...
        print_test_result(f"{method} {endpoint}",
...
def main():
    ...
    print(
        f"🚀 Iniciando testes em: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    report_file = f"docs/api_test_report_{timestamp}.json"
