...
def add_basic_geodata(net):
    ...
    for _, line in net.line.iterrows():
        ...
        to_bus = line.to_bus
        from_coords = (
            net.bus_geodata.iloc[from_bus].x, net.bus_geodata.iloc[from_bus].y)
        to_coords = (net.bus_geodata.iloc[to_bus].x,
                     net.bus_geodata.iloc[to_bus].y)
...
def test_basic_functionality():
    ...
    try:
        ...
        trafo = pp.create_transformer(
            net, bus1, bus2, std_type="0.4 MVA 20/0.4 kV")
